 ...
 */
    ...
    class QRcode {
        ...
        //----------------------------------------------------------------------
        public static function jpg($text, $outfile = false, $level = QR_ECLEVEL_H, $size = 80, $margin = 4, $saveandprint=false, $back_color = 0xFFFFFF, $fore_color = 0x000000) 
        {
            $enc = QRencode::factory($level, $size, $margin, $back_color, $fore_color);
    ...
    class QRencode {
        ...
        public function encodeJPG($intext, $outfile = false,$saveandprint=false) 
        {
            try {
                ...
                QRimage::jpg($tab, $outfile, min(max(1, $this->size), $maxSize), $this->margin,$saveandprint, $this->back_color, $this->fore_color);
